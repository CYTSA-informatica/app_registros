  ...
  <div class="card-body">
    ...
    <form method="post" class="row g-2 g-md-3" id="registerFormMain">
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        ...
        <input type="datetime-local" class="form-control" name="fecha" id="registerFecha" 
               value="<?= htmlspecialchars((string) ($registerForm['fecha'] ?? ''), ENT_QUOTES, 'UTF-8') ?>">
      ...
      <?php if ($registerForm['id']): ?>
        <div class="col-12 col-sm-6 col-lg-3">
          ...
          <input type="text" class="form-control" value="<?= htmlspecialchars((string) ($registerForm['fecha_actualizacion'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" disabled>
          <small class="text-muted">Automático al modificar</small>
        </div>
      <?php endif; ?>
      <div class="col-12 col-sm-6 col-lg-2">
