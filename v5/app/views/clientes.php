    ...
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <form class="row g-2 mb-3" id="clientFilters" onsubmit="return false;">
          ...
          <div class="col-4 col-md-1 d-grid">
            <button type="button" class="btn btn-outline-primary" id="clientExport">📥 Exportar</button>
          </div>
        </form>
...
<script>
  (() => {
    ...
    XlsxExport.attachExportVisibleButton('#clientExport', '#clientTableBody', 'clientes', { tabla: 'clients' });
  })();
</script>
