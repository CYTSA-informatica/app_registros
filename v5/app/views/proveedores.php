    ...
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <form class="row g-2 mb-3" id="providerFilters" onsubmit="return false;">
          ...
          <div class="col-4 col-md-1 d-grid">
            <button type="button" class="btn btn-outline-primary" id="providerExport">📥 Exportar</button>
          </div>
        </form>
...
<script>
  (() => {
    ...
    XlsxExport.attachExportVisibleButton('#providerExport', '#providerTableBody', 'proveedores', { tabla: 'providers' });
  })();
</script>
