...
function ensure_users_dpto_column(PDO $pdo): void
{
    ...
    if ((int) $stmt->fetchColumn() === 0) {
        $pdo->exec("ALTER TABLE users ADD COLUMN dpto VARCHAR(100) NOT NULL DEFAULT '' AFTER email");
    }
