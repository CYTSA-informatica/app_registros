...
CREATE TABLE users (
    ...
    dpto VARCHAR(100) NOT NULL DEFAULT '',
...
-- Usuario admin
INSERT INTO users (username, contra_hash, email, dpto, isAdmin) VALUES ('admin', SHA2('admin123', 256), 'informatica@cytsa.es', 'Informatica', 1);