      ...
      <div class="card-body">
        ...
        <form class="row g-2 mb-3" id="employeeFilters" onsubmit="return false;">
          <div class="col-12 col-md-8">
            <input type="text" class="form-control" id="employeeFilterText" placeholder="Buscar por usuario o email">
          </div>
        ...
        <div class="table-responsive">
          <table class="table table-sm align-middle">
            <thead>
              <tr><th>Usuario</th><th class="d-none-mobile">Email</th><th>Rol</th><th class="action-cell">Acciones</th></tr>
            </thead>
            <tbody id="employeeTableBody">
              <?php foreach ($users as $u): ?>
                <tr
                  data-search="<?= htmlspecialchars(((string) ($u['username'] ?? '')) . ' ' . ((string) ($u['email'] ?? '')), ENT_QUOTES, 'UTF-8') ?>"
